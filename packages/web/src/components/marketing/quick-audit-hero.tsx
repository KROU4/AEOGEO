...
export function QuickAuditHero() {
      ...
      {result ? (
        <div className="mt-8 space-y-6 border-t border-border pt-8">
          <div className="flex flex-col gap-6 md:flex-row md:items-start">
            <div className="flex shrink-0 flex-col items-center justify-center rounded-2xl border border-primary/30 bg-primary/5 px-8 py-6">
              ...
              <p
                ...
                style={{
                  fontFamily: "var(--font-avop-heading, var(--font-sans))",
                }}
              >
