...
const TOOLTIP_STYLE = { background: "#1b1c1d", border: "none", borderRadius: 4 };

const PALETTE = ["#4cd7f6", "#a78bfa", "#fb923c", "#6ee7b7", "#f472b6", "#94a3b8"];

/** Competitors analytics (SoV, table, trajectory) — embedded on the Visibility page. */
export function CompetitorsAnalyticsSection() {
    ...
    <div className="space-y-6">
      <div>
        <h2
          ...
          style={{ fontFamily: "var(--font-avop-heading)" }}
        >
